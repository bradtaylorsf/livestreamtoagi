...
def _coliseum_plan() -> BuildPlan:
    return BuildPlan(
        ...
        size_class="epic",
        source_image_id="catalog:roman-colosseum-blueprint-v1",
        footprint=Footprint(shape="oval", bbox=BoundingBox(x=0, y=0, w=120, h=100)),
        levels=[
            Level(index=0, height_blocks=8, floor_material="sand"),
            Level(index=1, height_blocks=8, floor_material="smooth_sandstone"),
            Level(index=2, height_blocks=8, floor_material="smooth_sandstone"),
            Level(index=3, height_blocks=6, floor_material="smooth_sandstone"),
            Level(index=4, height_blocks=6, floor_material="smooth_sandstone"),
        ],
        rooms=[
            Room(
                name="north_gate",
                level_index=0,
                relative_bbox=BoundingBox(x=55, y=0, w=10, h=12),
            ),
            Room(
                name="south_gate",
                level_index=0,
                relative_bbox=BoundingBox(x=55, y=88, w=10, h=12),
            ),
            Room(
                name="east_gate",
                level_index=0,
                relative_bbox=BoundingBox(x=108, y=45, w=12, h=10),
            ),
            Room(
                name="west_gate",
                level_index=0,
                relative_bbox=BoundingBox(x=0, y=45, w=12, h=10),
            ),
        ],
        materials=[
            MaterialAssignment(region="floor", material="sand"),
            MaterialAssignment(region="arena", material="sand"),
            MaterialAssignment(region="base", material="stone_bricks"),
            MaterialAssignment(region="walls", material="smooth_sandstone"),
            MaterialAssignment(region="columns", material="smooth_sandstone"),
            MaterialAssignment(region="seats", material="smooth_sandstone_stairs"),
            MaterialAssignment(region="band", material="chiseled_stone_bricks"),
            MaterialAssignment(region="trim", material="polished_andesite"),
            MaterialAssignment(region="slabs", material="smooth_sandstone_slab"),
            MaterialAssignment(region="lighting", material="lantern"),
        ],
        key_features=[
            KeyFeature(kind="column", position=Position3D(x=8, y=0, z=8), size={"height": 8}),
            KeyFeature(kind="column", position=Position3D(x=111, y=0, z=8), size={"height": 8}),
            KeyFeature(kind="column", position=Position3D(x=8, y=0, z=91), size={"height": 8}),
            KeyFeature(kind="column", position=Position3D(x=111, y=0, z=91), size={"height": 8}),
            KeyFeature(
                kind="arch",
                position=Position3D(x=56, y=6, z=0),
                size={"span": 8, "height": 8},
            ),
        ],
        decomposer_version=_DECOMPOSER_VERSION,
        provider_model_id=_PROVIDER_MODEL_ID,
