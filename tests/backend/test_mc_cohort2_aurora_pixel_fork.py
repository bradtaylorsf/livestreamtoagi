"""Tests for E8-3 Aurora/Pixel/Fork embodied Mindcraft cohort.
...
COHORT = {
    "aurora": {
        "name": "Aurora",
        "script": REPO_ROOT / "scripts" / "minecraft" / "connect-aurora-bot.sh",
        "settings": REPO_ROOT / "scripts" / "minecraft" / "mindcraft-settings-aurora.js",
        "profile": REPO_ROOT / "scripts" / "minecraft" / "profiles" / "aurora-bot.json",
    },
    "pixel": {
        "name": "Pixel",
        "script": REPO_ROOT / "scripts" / "minecraft" / "connect-pixel-bot.sh",
        "settings": REPO_ROOT / "scripts" / "minecraft" / "mindcraft-settings-pixel.js",
        "profile": REPO_ROOT / "scripts" / "minecraft" / "profiles" / "pixel-bot.json",
    },
    "fork": {
        "name": "Fork",
        "script": REPO_ROOT / "scripts" / "minecraft" / "connect-fork-bot.sh",
        "settings": REPO_ROOT / "scripts" / "minecraft" / "mindcraft-settings-fork.js",
        "profile": REPO_ROOT / "scripts" / "minecraft" / "profiles" / "fork-bot.json",
    },
}
...
def _load_gen_module():
    spec = importlib.util.spec_from_file_location("mc_gen_profiles_cohort2", GEN_SCRIPT)
