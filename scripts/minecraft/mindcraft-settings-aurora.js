// ----------------------------------------------------------------------------
// Committed Mindcraft settings template - points Aurora at the E2 server.
//
// This is the E8-3 verbal cohort variant of mindcraft-settings-alpha.js.
// scripts/minecraft/connect-aurora-bot.sh stages this reviewed template into
...
//   - one profile: ./profiles/aurora-bot.json
//   - no spawn init message; decentralized respond/ignore is E8-5/E8-6
//   - Aurora is verbal in Minecraft chat; TTS remains Python-side
// ----------------------------------------------------------------------------
const settings = {
