// ----------------------------------------------------------------------------
// Committed Mindcraft settings template - points Vera at the E2 server.
//
// This is the E8-2 verbal cohort variant of mindcraft-settings-alpha.js.
// scripts/minecraft/connect-vera-bot.sh stages this reviewed template into
...
//   - one profile: ./profiles/vera-bot.json
//   - no spawn init message; decentralized respond/ignore is E8-5/E8-6
//   - Vera is verbal in Minecraft chat; TTS remains Python-side
// ----------------------------------------------------------------------------
const settings = {
