...
// contract.PROTOCOL_VERSION (ADR §3). 1.7 is the E11-5 (#598) minor bump:
// `kill.status` lets Node bots poll the global kill switch and safe-idle
// locally. The server only gates on the major, so this stays wire-compatible
// with earlier 1.x peers.
