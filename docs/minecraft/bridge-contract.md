...
perception snapshot definitions, E7-2 added `errand.poll`, E7-3 added
`errand.complete`, and E11-5 added `kill.status`; all are additive minor bumps).
Same-major versions are
