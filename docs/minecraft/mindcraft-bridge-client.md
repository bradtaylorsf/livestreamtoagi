...
a contract-valid `BridgeRequest`: `version:"1.10"`, a unique `request_id`,
...
instrumentation. The current client speaks protocol 1.10, which also includes
the additive E6/E7 world verbs, E8.5 director gate, E11-5 kill status,
E12-12 shared-state blackboard verbs, and E12-13 distress/rescue fields. No new npm dependency (the
