...
instrumentation. The current client speaks protocol 1.7, which also includes
the additive E6/E7 world verbs and E11-5 kill status. No new npm dependency (the
