...
- Realtime: WebSocket event bus in `core/event_bus.py` (19 event types, 50-message history buffer, max 100 connections)
...
scripts/                Utility scripts: chat.py, test_agent.py, watch_conversations.py, run_simulation.py, run_eval.py, run_evolution.py, run_reflection_test.py, report_simulation.py, snapshot_memory.py, restore_memory.py, seed_config.py, check_tool_coverage.py, check-services.sh
...
- The admin dashboard backend (`/api/admin/*`) is live with 53 endpoints; the public-facing API routes called from `website/src/lib/api.ts` are not yet served by the backend
